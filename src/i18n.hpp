...
enum class StrKey {
    ...
    DISCLAIMER,
    PART_ENC, PART_DEC, PART_WARN, PART_LOGICAL_MODE, PART_PHYSICAL_MODE, PART_SYS_BLOCKED, PART_CANT_SYS, PART_CONFIRM, PART_CANCELLED, PART_ENCRYPTING, PART_DECRYPTING, PART_RECOVERY, PART_AVAIL_VOL, PART_AVAIL_DISK, PART_SELECT, PART_GB, PART_DONE, PART_CHOICE
};
